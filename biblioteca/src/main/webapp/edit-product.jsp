...
<header>
	...
	<form action="<%= request.getContextPath() %>/livros/edit" method="post" enctype="multipart/form-data">
	
		<div class="mb-3">
		  <label for="id" class="form-label">#id</label>
		  <input type="number" name="field-id" class="form-control" id="id" value="<%=livro.getId() %>" readonly>
		</div>
		
		<div class="mb-3">
		  <label for="name" class="form-label">Product Name</label>
		  <input type="text" name="field-name" class="form-control" id="name" value="<%=livro.getName() %>">
		</div>
		
		<div class="mb-3">
		  <label for="price" step='0.01' class="form-label">Data de Lançamento:</label>
		  <input type="text" name="field-date" class="form-control" id="price" value="<%=livro.getDataLancamento() %>">
		</div>
		
		<div class="mb-3">
		  <label for="description" class="form-label">Description</label>
		  <textarea class="form-control" name="field-description" id="description" rows="3"><%= livro.getDescription() %></textarea>
		</div>
